...
{
    // set QCore settings
    QCoreApplication::setOrganizationName("Cabnet Media Inc.");
    QCoreApplication::setOrganizationDomain("cabnet.media");
    QCoreApplication::setApplicationName("Cabnet Player");

    // explicitly declaring because we want to use the ini format
    // see https://doc.qt.io/qt-6/qsettings.html for details
    QSettings settings(QSettings::IniFormat, QSettings::UserScope, "Cabnet Media Inc.", "Cabnet Player");

    QGuiApplication app(argc, argv);
    QGuiApplication::setApplicationDisplayName("Cabnet Player");
